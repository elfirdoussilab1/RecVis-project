...
fontsize = 35  # Change this to adjust title font size
labelsize = 30  # Change this to adjust axis labels and colorbar labels
...
axes[0].tick_params(axis = 'x', which = 'both', labelsize = labelsize)
axes[0].tick_params(axis = 'y', which = 'both', labelsize = labelsize)
...
axes[1].tick_params(axis = 'x', which = 'both', labelsize = labelsize)
axes[1].tick_params(axis = 'y', which = 'both', labelsize = labelsize)
...
axes[2].tick_params(axis = 'x', which = 'both', labelsize = labelsize)
axes[2].tick_params(axis = 'y', which = 'both', labelsize = labelsize)
